...
const ApproveTabel = ({ paidLeaveData }) => {
    //membuat workhours
    ...
    return (
        <table className="w-full bg-white">
            ...
            <tbody>
                {paidLeaveData ? paidLeaveData.filter((data) => data.approval === "Approved").map((data, index) => (
                    <tr className="border-b" key={index}>
                        ...
                        <td className="text-center"><span className="bg-green text-white p-3 pt-2 pb-2  font-semibold rounded text-xs">Approved</span></td>
                    </tr>
                )) : <Spinner />}
            </tbody>
        </table >
