                            ...
                            {data.approval === 'Wait For Response' &&
                                <div className="flex flex-col w-full">
                                    <div className="flex justify-between w-full gap-2">
                                        ...
                                        <Button disabled={isPending} isProcessing={isPending} processingSpinner={<Spinner size={'sm'} />} className="flex justify-center items-center" color="green" onClick={handleCancel}>
