...
const RejectPurchaseInquiryBoxUser = ({inquiryData}) => {
    const totalRejectedPurchase = inquiryData?.filter((data) => data.category === 'Purchase' && data.approval === 'Rejected').length
    return (
        <div className="2xl:w-80 w-64 h-full flex flex-col bg-white justify-between rounded p-5">
            <div className="flex justify-between items-center">
                <div className='text-3xl font-bold text-primary'>
                    <span>{totalRejectedPurchase}</span>
                </div>
...
export default RejectPurchaseInquiryBoxUser;