    ...
    <>
      {WFO ? <Camera refetch={refetchPresence} status={status} checkInPopUp={CheckInPopUp} refetchPresence={refetchPresence} /> : 
        <div className="fixed w-full h-full inset-0 flex items-center justify-center z-20 bg-black/60">
          <div className="fixed top-1/2 transform -translate-y-1/2 bg-white p-8 w-2/5 h-80 rounded-lg">
            ...
            <div className="flex items-center justify-center mt-6 gap-x-14">
              <div className="flex flex-col gap-2 group">
                <button onClick={handleCheckinWFO} className="flex justify-center items-center bg-purple hover:bg-purple-dark transition-all duration-200 w-32 h-32 rounded-full transform group-hover:scale-105">
              ...
              <div className="flex flex-col gap-2 group">
                <button className="flex justify-center items-center bg-purple hover:bg-purple-dark transition-all duration-200 w-32 h-32 rounded-full transform group-hover:scale-105">
