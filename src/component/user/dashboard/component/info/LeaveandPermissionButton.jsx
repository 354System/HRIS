...
const LeaveAndPermissionButton = () => {
  ...
  return (
    <div className="laptop:w-64 h-full hp:w-full flex laptop:flex-col laptop:gap-6 hp:gap-4">
      <div className="hp:w-full laptop:w-full hp:h-14 rounded-lg">
        <button onClick={handleLeave} className="laptop:w-64 hp:w-full laptop:h-[56px] hp:h-full hp:gap-3 flex items-center p-3 bg-purple hover:bg-purple-dark transition duration-200 ease-in-out text-center rounded-lg">
      ...
      <div className="rounded-lg hp:w-full laptop:w-full hp:h-14">
        <button onClick={handlePermision} className="laptop:w-64 hp:w-full laptop:h-[56px] hp:h-full hp:gap-3 flex items-center p-3 bg-yellow hover:bg-yellow-dark transition duration-200 ease-in-out text-center rounded-lg">
          <Icon
