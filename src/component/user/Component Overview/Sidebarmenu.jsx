    ...
    return (
        <div className="flex flex-col justify-between items-center w-16 h-full bg-white py-4 shadow-lg rounded-lg">
            ...
            <div className='w-full flex flex-col justify-center items-center'>
                ...
                <Link to={'/attendanceHistori'}>
                <BiUser size={23} className={`cursor-pointer mb-5 w-full ${location.pathname === '/attendanceHistori' ? 'text-purple border-r-2 border-purple' : 'text-grey hover:text-primary'}`} />
                </Link>
